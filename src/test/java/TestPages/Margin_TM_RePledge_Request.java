...
public class Margin_TM_RePledge_Request {
	...
	public Margin_TM_RePledge_Request(WebDriver driver, WebDriverWait Wait) {
	...
	// --------------for Request for Margin_Pledge_Request creation process-------------
	...
	public void Margin_TM_RePledge_Request_Maker() {
