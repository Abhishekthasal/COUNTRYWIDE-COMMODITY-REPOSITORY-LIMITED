	  ...
	  void Pledge_Creation_WareHouse_CR318 () throws IOException {
		try {
		  ...
		  LoginPages Login = new LoginPages(driver, Wait);
			...
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Pledge_Creation_WareHouse_CR318"))
			...
			test.log(LogStatus.FAIL,
					test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Pledge_Creation_WareHouse_CR318")) + "Test failed for Pledge_Creation_WareHouse_CR318: "+e.getMessage());
		}
		Report.endTest(test);
		Report.flush();
	} 
	  ...
	  void Physical_Deposit_Pending_CR318 () throws IOException {
		try {
		  ...
		  LoginPages Login = new LoginPages(driver, Wait);
			...
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Physical_Deposit_Pending_CR318"))
			...
			test.log(LogStatus.FAIL,
					test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Physical_Deposit_Pending_CR318")) + "Test failed for Physical_Deposit_Pending_CR318: "+e.getMessage());
		}
		Report.endTest(test);
		Report.flush();
	} 
	  ...
	  void Withdrawal_Confirm_Pending_CR318 () throws IOException {
		try {
		  ...
		  LoginPages Login = new LoginPages(driver, Wait);
			...
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Withdrawal_Confirm_Pending_CR318"))
			...
			test.log(LogStatus.FAIL,
					test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Withdrawal_Confirm_Pending_CR318")) + "Test failed for Withdrawal_Confirm_Pending_CR318: "+e.getMessage());
		}
		Report.endTest(test);
		Report.flush();
	} 
	  ...
	  void Deposit_Confirm_Pending_CR318 () throws IOException {
		try {
		  ...
		  LoginPages Login = new LoginPages(driver, Wait);
			...
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Deposit_Confirm_Pending_CR318"))
			...
			test.log(LogStatus.FAIL,
					test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Deposit_Confirm_Pending_CR318")) + "Test failed for Deposit_Confirm_Pending_CR318: "+e.getMessage());
		}
		Report.endTest(test);
		Report.flush();
	} 
	  ...
	  void Deposit_Assayer_Pending_CR318 () throws IOException {
		try {
		  ...
		  Login.PortalLogin("Asyr-3338084", "user1", "121@test");
			...
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Deposit_Assayer_Pending_CR318"))
			...
			test.log(LogStatus.FAIL,
					test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver, "Deposit_Assayer_Pending_CR318")) + "Test failed for Deposit_Assayer_Pending_CR318:"+e.getMessage());
		}
		Report.endTest(test);
		Report.flush();
	} 
