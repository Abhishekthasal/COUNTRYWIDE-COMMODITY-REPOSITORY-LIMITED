...
public class Pledgor_Margin_Depledge_TestCase extends BaseClass {
	...
	void Pledgor_CM_Margin_DePledge_Request_Confirm_Checker() throws IOException {
		try {
			test.log(LogStatus.INFO, "Login for Pledgor_CM_Margin_DePledge_Request_Confirm_Checker start");
			LoginPages Login = new LoginPages(driver, Wait);
			Login.PortalLogin("rp-abhishek", "user52", "121@test");
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)));
			test.log(LogStatus.INFO, "Pledgor_CM_Margin_DePledge_Request_Confirm_Checker creation  start");
			TestPages.Margin_Pledge_Checker DePledge = new TestPages.Margin_Pledge_Checker(driver, Wait);
			DePledge.Pledgor_CM_Margin_DePledge_Request_Confirm_Checker();
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver))
					+ "Pledgor_CM_Margin_DePledge_Request_Confirm_Checker is success full");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
			test.log(LogStatus.INFO, "LogOut for Pledgor_CM_Margin_DePledge_Request_Confirm_Checker  Start");
			TestPages.LogoutPage Log = new TestPages.LogoutPage(driver, Wait);
			Log.Logout();
			test.log(LogStatus.INFO, "LogOut for Pledgor_CM_Margin_DePledge_Request_Confirm_Checker  END");
		} catch (Exception e) {
			test.log(LogStatus.FAIL, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)) + e.getMessage()
					+ "Pledgor_CM_Margin_DePledge_Request_Confirm_Checker Test failed");
		}
		Report.endTest(test);
		Report.flush();
	}
	...
	/****************************************************
	 * Pledgor_CC_Margin_DePledge_Request_Maker
	 ***********************************/

	// @Test
	void Pledgor_CC_Margin_DePledge_Request_Maker() throws IOException {
		try {
			test.log(LogStatus.INFO, "Login for Pledgor_CC_Margin_DePledge_Request_Maker start");
			LoginPages Login = new LoginPages(driver, Wait);
			Login.PortalLogin("CC8880013", "user1", "121@test");
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)));
			test.log(LogStatus.INFO, "Pledgor_CC_Margin_DePledge_Request_Maker creation  start");
			TestPages.CC_Margin_DePledge_Request Margin = new TestPages.CC_Margin_DePledge_Request(driver, Wait);
			Margin.Pledgor_CC_Margin_DePledge_Request_Maker();
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver))
					+ "Pledgor_CC_Margin_DePledge_Request_Maker is success full");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Maker  Start");
			TestPages.LogoutPage Log = new TestPages.LogoutPage(driver, Wait);
			Log.Logout();
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Maker  END");
		} catch (Exception e) {
			test.log(LogStatus.FAIL, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)) + e.getMessage()
					+ "Pledgor_CC_Margin_DePledge_Request_Maker Test failed");
		}
		Report.endTest(test);
		Report.flush();
	}
	...
	// @Test
	void Pledgor_CC_Margin_DePledge_Request_Checker() throws IOException {
		try {
			test.log(LogStatus.INFO, "Login for Pledgor_CC_Margin_DePledge_Request_Checker start");
			LoginPages Login = new LoginPages(driver, Wait);
			Login.PortalLogin("CC8880013", "user2", "121@test");
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)));
			test.log(LogStatus.INFO, "Pledgor_CC_Margin_DePledge_Request_Checker creation  start");
			TestPages.Margin_Pledge_Checker DePledge = new TestPages.Margin_Pledge_Checker(driver, Wait);
			DePledge.Pledgor_CC_Margin_DePledge_Request_Checker();
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver))
					+ "Pledgor_CC_Margin_DePledge_Request_Checker is success full");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Checker  Start");
			TestPages.LogoutPage Log = new TestPages.LogoutPage(driver, Wait);
			Log.Logout();
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Checker  END");
		} catch (Exception e) {
			test.log(LogStatus.FAIL, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)) + e.getMessage()
					+ "Pledgor_CC_Margin_DePledge_Request_Checker Test failed");
		}
		Report.endTest(test);
		Report.flush();
	}
	...
	void Pledgor_CC_Margin_DePledge_Request_Confirm_Maker() throws IOException {
		try {
			test.log(LogStatus.INFO, "Login for Pledgor_CC_Margin_DePledge_Request_Confirm_Maker start");
			LoginPages Login = new LoginPages(driver, Wait);
			Login.PortalLogin("CC8880013", "user1", "121@test");
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)));
			test.log(LogStatus.INFO, "Pledgor_CC_Margin_DePledge_Request_Confirm_Maker creation  start");
			TestPages.CC_Margin_DePledge_Confirm DePledge = new TestPages.CC_Margin_DePledge_Confirm(driver, Wait);
			DePledge.Pledgor_CC_Margin_DePledge_Request_Confirm_Maker();
			test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver))
					+ "Pledgor_CC_Margin_DePledge_Request_Confirm_Maker is success full");
			driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(30));
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Confirm_Maker  Start");
			TestPages.LogoutPage Log = new TestPages.LogoutPage(driver, Wait);
			Log.Logout();
			test.log(LogStatus.INFO, "LogOut for Pledgor_CC_Margin_DePledge_Request_Confirm_Maker  END");
		} catch (Exception e) {
			test.log(LogStatus.FAIL, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)) + e.getMessage()
					+ "Pledgor_CC_Margin_DePledge_Request_Confirm_Maker Test failed");
		}
		Report.endTest(test);
		Report.flush();
	}
